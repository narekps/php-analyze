 ...
 *   (E.g. this only includes direct composer dependencies - You may have to manually add indirect composer dependencies to
 *   'directory_list')
...
return [
    ...
    // As a result, enabling this setting with target_php_version 8.0 may result in false positives for `--redundant-condition-detection`
    // when codebases also support php 7.x.
    ...
    'suppress_issue_types'                              => ['PhanUndeclaredFunctionInCallable'],
